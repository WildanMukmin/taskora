                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="/taskora/pages/user/edit_task_user.php?id=<?= $task['id'] ?>" class="text-indigo-600 hover:text-indigo-900" title="Edit">
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                            </svg>
                            </a>
                            <?php if ($task['status'] !== 'done'): ?>
                                <a href="/taskora/pages/user/markdone_task_my_task.php?id=<?= $task['id'] ?>" class="text-green-600 hover:text-green-900" title="Complete" disabled>
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                </svg>
                                </a>
                            <?php endif; ?>
                            <a href="/taskora/pages/user/delete_task_my_task.php?id=<?= $task['id'] ?>" class="text-red-600 hover:text-red-900" title="Delete">
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
